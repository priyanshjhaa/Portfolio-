...
export default function SystemStateRail({ activeSection }: SystemStateRailProps) {
  ...
  return (
    <div className="fixed right-4 top-1/2 z-40 hidden w-72 -translate-y-1/2 xl:block">
      <div className="rounded-[28px] border border-white/8 bg-[#090909]/88 p-4 shadow-[0_28px_70px_-42px_rgba(0,0,0,0.95)] backdrop-blur-xl">
        <div className="mb-4 flex items-center justify-between">
          ...
          <div className="relative">
            <div className="h-3 w-3 rounded-full bg-accent shadow-[0_0_18px_rgba(76,175,80,0.55)]" />
